...
class ClassifierConfig(BaseModel):
	models_dir: Path = settings.app_root / settings.classifier_models_dir
	model_embed_local_name: str = settings.embedding_model_local_name
	model_label_binarizer_name: str = settings.model_label_binarizer_name
